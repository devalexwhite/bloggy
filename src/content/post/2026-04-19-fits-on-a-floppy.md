...
description: "I stumbled acrossMatt\u2019s\nworkvia a post on Tildes. His \u201Cmanifesto\
  \ for small software\u201D\ndescribes how he has targeted building applications\
  \ that could..."
tags: []
---

I stumbled across [Matt’s
work](https://fitsonafloppy.com/) via a post on Tildes. His “manifesto for small software”
...
All this has got me thinking, and when I start thinking I typically
end up changing my opinion on things. You see, I agree with Matt,
“software has lost its way”. My recent [post on using Palm OS for
weight tracking](https://thatalexguy.dev/back-to-palm-os) proves that. The extremely powerful database
software I talk about in that post is 758KB, heck you could
*almost* fit two copies on a floppy. For comparison, Numbers
(Apple’s spreadsheet software on iOS) is 617.2MB. You could fit 833
copies of the Palm OS app in that amount of space!

Here’s the thing, it’s going to get worse. Much worse. When
...
to run increasingly bloated software.

I’m sure Microsoft will be happy to rent a cloud server running
Copilot OS to you though…for a monthly fee of course.

All that to said, I’ve changed my mind (again) on using AI.
Admittedly I had started to give in due to it being used
**heavily** at work. What I’ve come to realize is that I
don’t want to make software that way, it’s not meaningful to me. As [@eniko said on Mastodon](https://mastodon.gamedev.place/@eniko/116426136253346140),
it’s taking the artistry out of coding. The artistry of a well optimized
system, of meaningful decisions, of re usability and composition.

I’ve been reading “Microinteractions: Designing with Details”” by Dan
...
Heck, the industry is [rushing head
first](https://designmd.ai/) into letting AI take over [everything
human](https://www.anthropic.com/news/claude-design-anthropic-labs) in the UX of applications.

Teams use AI to write the requirements documents. Then use AI to
...
What’s the point? You end up using software that had near zero human
...
the machine, what you’ve created is not something built for users.

So yeah, I’m done letting Claude create anything for me personally.
...
my [post on
using AI for writing](https://thatalexguy.dev/reon-ai-enhanced-writing), when you take the human out of the process
you’re not producing art. And code is art.
