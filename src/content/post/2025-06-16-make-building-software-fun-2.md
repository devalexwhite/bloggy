---
title: Make Building Software Fun
publishDate: '2025-06-16'
description: "I\u2019ve been writing software for a long time. When I was a kid, I\
  \ loved\nmaking text adventures, spending countless hours planning the dungeons\n\
  on pie..."
tags: []
---

I’ve been writing software for a long time. When I was a kid, I loved
making text adventures, spending countless hours planning the dungeons
...
trip. Back then, building software was **fun**.

My passion for building continued through college, where I released
apps on Windows and Windows Phone. After college I built and launched my
only app that’s ever made an actual profit, MetaShort.

But then, the fun stopped. As I advanced in my career as a developer,
...
design? Is this scalable? How do I optimize for SEO?

I’ve been stuck in this rut for years, but I think I’ve finally found
the way out. The key to building, is to make it fun, and that’s a lot
harder than it sounds.

As a kid, building games and apps was fun because I didn’t (couldn’t)
...
so I have to be intentional to let go of that.

I’m currently building BookLeaf, an open-source bookmark manager. I
...
But this time, I intentionally didn’t.

I spun up a Laravel project and stuck with Blade templates, inline
...
a MJP (most joyful product) if you will (sorry, had to).

The MJP is where I have something that proves to me “hey, you managed
...
people that have discovered it. That’s the fun part.

But here’s the thing, my path to MJP is not your path. Your path to a
