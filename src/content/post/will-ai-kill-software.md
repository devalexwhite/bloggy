---
title: Will AI Kill Software?
publishDate: '2026-03-01'
description: Yes (to a degree).
tags: ["software", "writing"]
---

Yes (to a degree).

I’ve always dreamt of running my own software company, something akin
...
(there’s a difference between realistic and possible) thanks to AI.

On the news you’ll constantly find articles heralding the death of
...
If SaaS is out, then what about desktop software? Platforms like
...
Who uses Photoshop when there’s Claude.

And that’s where my dreams lay, seemingly crushed by the death of
...
I do believe that B2B SaaS and software is dead. Why? Because nobody
...
place, so let Perplexity/Claude/Gemini/etc take the wheel.

Here’s the thing though, when you clock out for the day, the software
you interact with can instill joy. Suddenly you’re using [Acorn](https://flyingmeat.com/acorn/) to support your
photography hobby. You fire up [ia
Writer](https://ia.net/writer) to update your blog (what I’m typing with right now). You use
[Nova](https://nova.app/) to build the website for your
cycling club. Personal software has the opportunity to be fun.

Creative workflows are meaningful, exciting and joyful. The process
...
“Human creative” is what will save software. High quality tools that
instill joy by supporting the creative processes that make life
meaningful.

And honestly? Good riddance to “business creative”. I’m all for the
death of corporate software.
