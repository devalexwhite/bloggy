---
title: Are Design Tools Still Relevant?
publishDate: '2026-03-06'
description: 'I was a product designer for a few years. I had switched careers to
...
I was a product designer for a few years. I had switched careers to
design after suffering burn out as a software engineer. During those
...
only to then have somebody else build it again in code.

I recently had to put on my design hat again, putting together
...
frames and symbols in Figma.

Let me explain.

Enterprise apps have well defined brand guidelines. Colors, type,
...
from going off into the deep end.

Design then becomes focused on solving the user’s problem through UX,
...
The result is a more interactive, true to life prototype that gives
...
You can tell Figma is battling with this reality by pushing Figma
make. The issue is, it’s too constrained and produces poor results. You
can’t link it to existing coded components, Tailwind configs, etc.

On the other hand, usin my approach requires a technical background.
You need to guide with framework suggestions, foundational setup and be
able to takeover and tweak yourself.

That said, there in the shorter term there’s likely still a place for
...
the place, and small tweaks will be next to impossible.

As the technology gets better though, I’ll be surprised if Figma and
Sketch survive the next couple of years.
